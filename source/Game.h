...
// Enemies are loaded in by pairs
// Four sets of shredders and miners seems impossible, so there are only three sets of them
// Do not touch
extern int GameEnemiesToSpawn[10];

// Shuffles GameEnemySpawnIndexes to randomise the enemies to fight against
...
//      All the enemies are dead and there are no enemy bullets
//          Returns 1
//      The player dies
//          Returns 0
//      Select is pressed
