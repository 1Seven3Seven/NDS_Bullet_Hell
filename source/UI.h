...
#define UI_NUM_CHARS 32
/// The height of the ui in lines.
#define UI_NUM_LINES 24
...
typedef struct
{
    ...
    /// A function to be called on each update of a UI to allow for additional customisation, if present.
    /// Must be set directly after the struct has been initialised.
    void (*PrintFunction)(void);
} UIInterfaceStruct;

//
// UI Buffer and Screen Writing related
//
...
int UIUpdateInterface(UIInterfaceStruct *interface, int frame_number, u32 keys);
